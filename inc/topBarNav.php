<nav class="navbar navbar-expand-lg navbar-dark" style="background-color: rgb(173, 207, 230);">
            <div class="container-fluid px-4 px-lg-5 ">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        ...
                        <?php 
                        $cat_qry = $conn->query("SELECT * FROM categories where status = 1  limit 10");
                        ...
                        <li class="nav-item dropdown">
                          <a class="nav-link text-white dropdown-toggle" id="navbarDropdown<?php echo $crow['id'] ?>" href="#" role="button" data-toggle="dropdown" aria-expanded="false"><?php echo $crow['category'] ?></a></a>
                            ...
                            <?php while($srow = $sub_qry->fetch_assoc()):
                                // Override sub-category names
                                switch($srow['id']) {
                                    case 1:
                                        $sub_name = 'Sell Clothes';
                                        break;
                                    case 2:
                                        $sub_name = 'Buy Clothes';
                                        break;
                                    case 3:
                                        $sub_name = 'Sell Books';
                                        break;
                                    case 4:
                                        ...
                                        break;
                                    default:
                                        $sub_name = $srow['sub_category'];
                                }
                            ?>
                              <li>
                                <a class="dropdown-item border-bottom" 
                                  href="<?php 
                                    if ($srow['id'] == 1 || $srow['id'] == 3) 
                                      echo './?p=create_product&s=' . md5($srow['id']);
                                    else 
                                      echo './?p=products&c=' . md5($crow['id']) . '&s=' . md5($srow['id']);
                                  ?>">
                                  <?php echo $sub_name ?>
                                </a>
                              </li>
                        ...
                        <?php endif; ?>
                        <li class="nav-item"><a class="nav-link text-white" href="./?p=tradein">Trade-In</a></li>
